...
<h1>Edit Slide: {{$indexSlide->title}}</h1>
<hr>			

<div class="card mb-3">
	<div class="card-header">
		<i class="fa fa-table"></i> Edit Slide
	</div>
	<div class="card-body">
			...
			<div class="row">
				<fieldset class="col-lg-6">
					...
					<div class="form-group">
						<label>Title</label> 
						<input value="{{old('title', $indexSlide->title)}}" name="title" placeholder="Enter Title" required="required" class="form-control" type="text"> 
						@if($errors->has('title'))
					...
					<div class="form-group">
						<label>Url</label> 
						<input value="{{old('url', $indexSlide->url)}}" name="url" placeholder="Enter Url on slide click" class="form-control" type="text"> 
						@if($errors->has('url'))
						<div class="form-errors text-danger">
					...
					<div class="form-group">
						...
						<textarea name="description" placeholder="Enter Description" class="form-control" rows="12">{{old('description', $indexSlide->description)}}</textarea>
				...
				<fieldset class="col-lg-6">
					...
					<div class="text-center mb-5">
						@if($indexSlide->photo_filename && \Storage::disk('public')->exists('/index-slides/' . $indexSlide->photo_filename))
						<img 

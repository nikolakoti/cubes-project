                ...
                <fieldset class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                            <input name="painting_photo_file" type="file" class="custom-file-input" id="painting_photo_file">
                            <label class="custom-file-label" for="painting_photo_file">Choose photo</label>
                        </div>
                        @if($errors->has('painting_photo_file'))
                        <div class="form-errors text-danger">
                            @foreach($errors->get('painting_photo_file') as $errorMessage)
                            <label class="error">{{$errorMessage}}</label>
                            @endforeach
                        </div>
                        @endif
